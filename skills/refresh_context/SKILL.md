...
2. **Find or make an `agent_assets/<conversation_topic>` directory** - This is your personal knowledge store. 
- All agent-specific, internally used, or temporary artifacts and code must live under this directory.
- Find or make the following within this directory:
