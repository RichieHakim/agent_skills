...
- <agent_assets_meta_directory>: '/n/holylabs/kempner_rhakim_lab/Lab/rhakim/agent_assets/<repo>/' (symlink target for the repo's `agent_assets/` — see `agent-guide` SKILL.md for setup/usage)
...
- Ensure you are using the correct conda environment with `conda activate <conda_env_name>`.
