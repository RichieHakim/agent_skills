...
1. Read `references.md` (bundled with this skill); run `keeping-memories` skill.
...
- **Store artifacts** liberally.
  ...
  - Large or permanent artifacts (i.e., `.npy`, models) go to `<temp_data_dir>` which is defined in `references.md`.